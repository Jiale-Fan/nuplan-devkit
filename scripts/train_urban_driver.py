...
if __name__ == '__main__': 
    ...
    train_dicts.append(
        dict(
            ...
            CONFIG_NAME = 'autobots_training',
        
            # Name of the experiment
            EXPERIMENT = 'urban_driver_experiment',
            JOB_NAME = 'urban_driver_open_loop_model',
            TRAINING_MODEL = 'training_urban_driver_open_loop_model',
...
# to run tensorboard:
# tensorboard --logdir=/data1/nuplan/jiale/exp/urban_driver_experiment/urban_driver_model
